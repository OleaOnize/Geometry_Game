class Player {
  ...
  isColliding(obstacle) {
    ...
    if (
      this.x + this.width - tresholdCol >= obstacle.x &&
      ...
      if (
        obstacle.type === "pusher" &&
        this.x + this.width >= obstacle.x + treshold &&
        !this.isNoneGrav
      ) {
        this.y -= 1;
        this.isJumping = true;
        ...
        (obstacle.type === "jumperNeonBlue" ||
          obstacle.type === "jumper" ||
          obstacle.type === "jumperNeonViolet") &&
        this.prevY + this.height <= obstacle.y + tresholdCol &&
        !this.isNoneGrav
      ) {
        // hay top collision
        ...
        obstacle.type !== "arrowUp" &&
        obstacle.type !== "arrowDown"
      ) {
        this.isDead = true;
